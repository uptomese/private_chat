      ...
      <div class="col-4" style="padding-right: 0%">
        <div class="card card-default">
          <div class="has-search input-group">
            ...
            <input v-model="search" type="search" class="form-control" placeholder="Search name" />
          </div>
          <!-- <div class="card-header headlist"></div> -->
          <div class="card-body friends" style="overflow: auto; padding:0%">
            <ul class="list-group shotname" v-for="friend in filteredFriend" :key="friend.id">
              <li
                v-if="friend.id == select"
                class="list-group-item list-group-item-action active"
                style="text-decoration: none;"
              >
                <img src="images/pf1.jpeg" class="profileimg" />
                ...
                <div class="chat message">
                  ...
                  <a :id="'unread_message' + friend.id" class="letter">{{ friend.unread_message }}</a>
                </div>
              </li>
              <li
                type="button"
              ...
              >
                ...
                <div class="chat message">
                  <a v-if="friend.status == 'online'" class="username" style="color:green;">
                    {{ friend.name }}
                    <span
                      :id="'status_online' + friend.id"
                      v-if="friend.status == 'online'"
