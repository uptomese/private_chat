  ...
  <div v-if="friend_id" class="col-8" style="padding-left: 0%">
    <div class="card card-default card-box">
      <div class="has-search input-group">
        ...
        <input v-model="search" type="search" class="form-control" placeholder="Search message" />
        <div class="input-group-append">
          <span class="input-group-text">
            <div style="text-align: right;">
              <i class="far fa-file-image" type="button" @click.prevent="getFile()"></i>
            </div>
          </span>
        </div>
      ...
      >
        <div v-for="message in filteredMessage" :key="message.index">
          ...
          >
            ...
            <img src="images/pf3.png" alt="Picture" />
            ...
            <div class="ul_section_full">
              ...
              <ul v-else class="ul_msg">
                ...
                <li v-else :id="message.message_id">{{ message.message }}</li>
              </ul>
              <div class="clearfix"></div>
              <ul
                v-if="message.status != 3 && message.status != 4 && message.type != 'video_time'"
                class="ul_msg2"
              >
                <li>
                  <a
                ...
                <li>
                  <a :href="'#' + message.message_id" @click.prevent="deleteMessage(message)">
          ...
          <div v-else class="chatbox__body__message chatbox__body__message--left">
            <div class="chatbox_timing">
              <ul>
                <li>
                  <a>
            ...
            <img src="images/pf1.jpeg" alt="Picture" />
            <div class="clearfix"></div>
            <div class="ul_section_full">
              <ul
                v-if="message.status == 2 || message.type == 'image'"
      ...
      <div class="panel-footer">
        <div v-if="this.update == true" class="input-group-prepend">
          <span class="input-group-text" id="basic-addon1">{{ this.messageDisable }}</span>
          <input
            id="btn-input"
            type="text"
            class="form-control"
          ...
          />
          <i class="fas fa-location-arrow icon" @click.prevent="sendMessage"></i>
        </div>
        ...
        <div v-else>
          ...
          <div class="input-group-prepend" hidden>
            ...
            <button class="btn btn-success" @click="uploadImage(friend_id.session)">Upload</button>
          </div>
        </div>
      </div>
    </div>
